...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var LEAGUES = {
    baseball: [
      ...
      { key:'baseball_milb',   title:'⚾ MiLB',       panel:true },
  ...
  var ESPN_LEAGUE_MAP = {
    ...
    baseball_milb:{ sport:'baseball',league:'milb' },
  ...
  async function loadNPBGamesPanel(){
    ...
    try{
      ...
      hdr.style.cssText='font-family:DM Mono,monospace;font-size:0.68rem;color:#e91e7a;text-transform:uppercase;letter-spacing:0.1em;padding:6px 0;border-bottom:1px solid var(--border);margin-bottom:4px';
  ...
  async function loadMLBGamesPanel(leagueKey){
    ...
    if(isMiLB) espnMap={sport:'baseball',league:'milb'};
    var isMiLB=leagueKey==='baseball_milb';
    ...
    try {
      if(leagueKey==='baseball_npb'){
        ...
        var labels={'baseball_mlb':'⚾ MLB — Grandes Ligas',
                    'baseball_milb':'🌱 MiLB — Ligas Menores',
