...
document.addEventListener('DOMContentLoaded', function () {
  ...
  async function loadNPBGamesPanel(){
    ...
    try{
      ...
      var todayGames=buildNPBGamesFromProbable(npbJSON&&npbJSON.npb_probable_pitchers||{});
      var tomorrowGames=buildNPBGamesFromProbable(npbJSON&&npbJSON.npb_probable_tomorrow||{});

      // Fallback directo a npb.jp si JSON vacío
